# =============================================================================
# LLaVA-OneVision2 4B (Qwen3-4B + 300M ViT) – Stage-1 Alignment Training
# =============================================================================
#
...
#   • LLM  (4 B  params) : 36 transformer layers, hidden_size=2560
#
...
# ----------------------------------------
#  4  GPUs : TP=1  PP=4  --custom-pipeline-layers 0,12,12,12
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/LLaVA-OneVision-2/llava_onevision2_qwen3_4b_stage0_mcore_tp${TP}_pp${PP}"}
