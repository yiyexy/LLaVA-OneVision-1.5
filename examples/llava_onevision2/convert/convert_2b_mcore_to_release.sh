# =============================================================================
# LLaVA-OneVision2 2B – Re-shard Megatron-Core checkpoint (mcore → mcore)
# =============================================================================
#
...
#
# Usage:
#   bash convert_2b_mcore_to_release.sh <LOAD> <SAVE> <TP> <PP> [CUSTOM_PIPELINE_LAYERS]
#
# Arguments:
...
#
# Examples:
#   bash convert_2b_mcore_to_release.sh /src /dst 2 4 0,9,9,10
#   bash convert_2b_mcore_to_release.sh /src /dst 1 1
# =============================================================================
